...
Future<String?> _getCharacter() async{
  return await _localDatabase.getUserNameForParticularUser(userMail: FirebaseAuth.instance.currentUser!.toString());
}

class PreviousMessageGroupStructure {

  late String actualMessage;
  late String messageDate;
  late String messageTime;
  late String messageHolderName;
  late ChatMessageTypes messageType;

  PreviousMessageGroupStructure({required String actualMessage,
    ...
    messageHolderName = messageHolder;
  }

  factory PreviousMessageGroupStructure.toJson(Map<String, dynamic> map) {
    return PreviousMessageGroupStructure(
  ...
  ChatMessageTypes _getChatMessageTypePerfectly(String messageType) {
    ...
    }else if(messageType == ChatMessageTypes.Notify.toString()){
      return ChatMessageTypes.Notify;
    }
    else{
